...
module("menu_entry_calibration.py", base_path="/var/build/src/src/static_modules")
module("menu_entry_hardwaretest.py", base_path="/var/build/src/src/static_modules")
module("menu_entry_info.py", base_path="/var/build/src/src/static_modules")
module("menu_entry_restore.py", base_path="/var/build/src/src/static_modules")
module("menu_entry_scale.py", base_path="/var/build/src/src/static_modules")
module("menu_entry_submenu.py", base_path="/var/build/src/src/static_modules")
module("menu_manager.py", base_path="/var/build/src/src/static_modules")
...
module("recipe.py", base_path="/var/build/src/src/static_modules")
...
module("settings.py", base_path="/var/build/src/src/static_modules")
...
module("ui.py", base_path="/var/build/src/src/static_modules")
