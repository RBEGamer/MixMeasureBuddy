...
def RECIPES_COLLECTION_MARGARITA() -> recipe.recipe:
    ...
    m.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.SCALE, "Tequila", "Add", 50))
    ...
    m.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.CONFIRM, "Ice", "Add", 100))
...
def RECIPES_COLLECTION_MARTINI() -> recipe.recipe:
    ...
    ma.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.SCALE, "Gin or Vodka", "Add", 75))
    ma.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.SCALE, "Dry Vermouth", "Add", 15))
    ma.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.WAIT, "", "Stir with ice", 30))
    ma.valid = True
    return ma
...
def RECIPES_COLLECTION_OLD_FASHIONED() -> recipe.recipe:
    ...
    of.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.SCALE, "Whiskey", "Add", 50))
    of.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.CONFIRM, "Angostura Bitters", "Drops", 2))
    of.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.CONFIRM, "Ice", "Add", 100))
...
def RECIPES_COLLECTION_MOJITO() -> recipe.recipe:
    ...
    mo.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.SCALE, "White Rum", "Add", 50))
    mo.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.SCALE, "Sugar", "Add", 15))
    mo.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.SCALE, "Lime Juice", "Add", 25))
    mo.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.SCALE, "Soda Water", "Add", 100))
    mo.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.CONFIRM, "Ice", "Add", 100))
    mo.valid = True
    return mo
...
def RECIPES_COLLECTION_COSMOPOLITAN() -> recipe.recipe:
    ...
    c.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.CONFIRM, "Ice", "Add", 100))
...
def RECIPES_COLLECTION_DAIQUIRI() -> recipe.recipe:
    ...
    d.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.CONFIRM, "Ice", "Add", 100))
    d.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.WAIT, "", "Shake", 20))
    d.valid = True
    return d
...
def RECIPES_COLLECTION_PINA_COLADA() -> recipe.recipe:
    ...
    pc.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.SCALE, "White Rum", "Add", 50))
    pc.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.SCALE, "Coconut Cream", "Add", 60))
    pc.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.SCALE, "Pineapple Juice", "Add", 120))
    pc.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.CONFIRM, "Ice", "Add", 100))
    pc.add_step(recipe.recipe_step(recipe.USER_INTERACTION_MODE.WAIT, "", "Blend", 30))
    pc.valid = True
    return pc
